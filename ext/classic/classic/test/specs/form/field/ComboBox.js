...
function() {
    ...
    describe('AutoLoad config combo', function() {
        ...
        it('should load the data while typing when autoLoad is true', function() {
            ...
            expect(store.loadCount).toBeGreaterThan(0);
        });

        it('should not load the data while typing when autoLoad is false', function() {
            store = new Ext.data.Store({
                autoLoad: false,
                proxy: {
                    type: 'ajax',
        ...
        it('should not load the data while typing with default autoLoad config (autoLoad: undefined)', function() {
            store = new Ext.data.Store({
                proxy: {
                    type: 'ajax',
                    url: 'fakeUrl'
        ...
        it('should load the data while typing post manual load for autoLoad false.', function() {
            ...
            completeWithData([
                { text: 'Apple', value: 'value 10' },
                { text: 'Banana', value: 'value 11' },
                { text: 'BlueBerry', value: 'value 12' },
                { text: 'Orange', value: 'value 31' }
            ]);
